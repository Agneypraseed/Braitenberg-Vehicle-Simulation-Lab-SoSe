...
def create_demonstration_scenario():    
...
vehicle5, targets = create_demonstration_scenario()
running = True
...
while running:
    ...
    instruction_text = small_font.render(
        "Watch as the FRIEND vehicle approaches and triggers the reaction.", True, WHITE)
